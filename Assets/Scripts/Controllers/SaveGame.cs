...
public class SaveData : ISerializable {
	...
	public List<Entity> EnemiesInWorld;
	public List<Switch> SwitchesInWorld;
	public List<Door> DoorsInWorld;
	public Dictionary<string, bool> LogsFoundByPlayer;
	// === /Values ===
	...
	public SaveData (SerializationInfo info, StreamingContext ctxt)
	{
		...
		ItemsInWorld = (List<Item>)info.GetValue("ItemsInWorld", typeof(List<Item>));
		EnemiesInWorld = (List<Entity>)info.GetValue("EnemiesInWorld", typeof(List<Entity>));
		SwitchesInWorld = (List<Switch>)info.GetValue("SwitchesInWorld", typeof(List<Switch>));
		DoorsInWorld = (List<Door>)info.GetValue("DoorsInWorld", typeof(List<Door>));
		LogsFoundByPlayer = (Dictionary<string, bool>)info.GetValue("LogsFoundByPlayer", typeof(Dictionary<string, bool>));
	...
	public void GetObjectData (SerializationInfo info, StreamingContext ctxt)
	{
		...
		info.AddValue("ItemsInWorld", ItemsInWorld);
		info.AddValue("EnemiesInWorld", EnemiesInWorld);
		info.AddValue("SwitchesInWorld", SwitchesInWorld);
		info.AddValue("DoorsInWorld", DoorsInWorld);
		info.AddValue("LogsFoundByPlayer", LogsFoundByPlayer);
	}
}
